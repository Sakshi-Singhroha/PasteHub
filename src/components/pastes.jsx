...
//             <div className='flex flex-col border border-green-700 gap-5 mt-6'>
//                 {filteredData.map((paste) => (
//                     <div
//                         key={paste._id}
//                         className='border border-green-700 p-5 rounded-xl bg-black text-white relative'
//                     >
...
const Pastes = () => {
    ...
    return (
        <div className='p-5'>
            <input
                className="mt-5 p-2 pl-3 rounded-2xl w-full bg-gray-800 text-white border-0 focus:border-2 focus:border-green-500 focus:outline-none"
                type='search'
                placeholder='Search here'
                value={searchTerm}
                onChange={(e) => setSearchTerm(e.target.value)}
            ...
            <div className='flex flex-col gap-5 mt-6'>
                {filteredData.map((paste) => (
                    <div
                        key={paste._id}
                        className='border-2 border-green-600 shadow-md p-5 rounded-xl bg-grey-700 text-white relative transition hover:shadow-lg'
                    >
                        <div className='flex justify-between items-start'>
                            <div>
                                <div className='text-2xl font-bold text-brown-400'>{paste.title}</div>
                                <div className='text-md mt-2 text-gray-300 whitespace-pre-line'>
                                    {truncateText(paste.content, 100)}
                                </div>
                            </div>
