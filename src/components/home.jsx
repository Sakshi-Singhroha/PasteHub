...
const Home = () => {
  ...
  return (
    <div className="w-full min-h-screen border border-green-500  rounded-xl flex flex-col items-center justify-start bg-[#18181b] px-4 py-8">
      <form
        onSubmit={createPaste}
        className="w-full max-w-2xl bg-[#232329] rounded-2xl shadow-lg border border-[#35353b] p-8"
        autoComplete="off"
      >
        <input
          className="w-full mb-3 px-4 py-3 rounded-xl bg-[#18181b] border border-green-300 text-white placeholder-gray-400 focus:outline-none text-lg font-semibold"
          type="text"
          placeholder="Enter your title *"
          value={title}
          onChange={(e) => {
        ...
        <textarea
          className="w-full min-h-[250px] mb-6 bg-[#18181b] border border-green-300 text-gray-200 font-mono text-base px-4 py-3 rounded-xl border border-[#27272a] focus:outline-none resize-none"
          placeholder="Enter the content here"
          value={value}
          rows={12}
          onChange={(e) => setValue(e.target.value)}
        ...
        <div className="flex justify-end">
          <button
            ...
            className={`px-6 py-3 font-semibold rounded-xl shadow transition ${
              title.trim()
                ? 'bg-green-500  hover:bg-green-400 border border-green-300 text-white'
                : 'bg-gray-500 text-gray-300 cursor-not-allowed'
            }`}
            disabled={!title.trim()}
          >
